                ...
                <form action="register.php" method="POST" class="needs-validation" novalidate>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="username" id="username" class="form-control form-control-custom border-start-0 ps-0" placeholder="e.g. johndoe" required value="<?php echo isset($username) ? $username : ''; ?>">
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="email" name="email" id="email" class="form-control form-control-custom border-start-0 ps-0" placeholder="e.g. john@example.com" required value="<?php echo isset($email) ? $email : ''; ?>">
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="password" name="password" id="password" class="form-control form-control-custom border-start-0 ps-0" placeholder="Min. 6 characters" required>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="password" name="confirm_password" id="confirm_password" class="form-control form-control-custom border-start-0 ps-0" placeholder="Repeat password" required>
                        </div>
                    </div>
