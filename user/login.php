    ...
    <div class="col-md-5">
        <div class="glass-container p-4 p-md-5">
            ...
            <form action="login.php" method="POST">
                <!-- Username or Email -->
                <div class="mb-3">
                    <label for="login_input" class="form-label small fw-bold text-secondary">Username or Email Address</label>
                    <div class="input-group">
                        <span class="input-group-text bg-light border-0"><i class="bi bi-envelope text-muted"></i></span>
                        <input type="text" name="login_input" id="login_input" class="form-control form-control-custom border-start-0" placeholder="Username or Email" required value="<?php echo isset($login_input) ? $login_input : ''; ?>">
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="password" name="password" id="password" class="form-control form-control-custom border-start-0" placeholder="Password" required>
                    </div>
                </div>
